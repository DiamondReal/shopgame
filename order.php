										...
										<div class="flex-lg-row-fluid me-xl-18 mb-10 mb-xl-0">
											<div class="mt-n1">
												<div class="d-flex flex-stack pb-10">
													<a href="#">
														<img alt="Logo" src="https://cdn.discordapp.com/attachments/1083423328859070554/1131765247275958272/ALL_SERVICE.png">
													</a>
												...
												<div class="m-0">
													...
													<div class="row g-5 mb-12">
														...
														<div class="col-sm-6">
															...
															<div class="fw-bolder fs-6 text-gray-800">Diamond</div>
														</div>
														<!--end::Col-->
													</div>
													<!--end::Row-->
										...
										<div class="m-0">
											<div class="d-print-none border border-dashed border-gray-300 card-rounded h-lg-100 min-w-md-350px p-9 bg-lighten">
												...
												<div class="mb-15">
													...
													<span class="bullet bullet-dot bg-danger mx-2"></span>หมด1วันแล้วไม่มีประกัน</span></div>
												</div>
												<div class="mb-6">
													<div class="fw-bold text-gray-600 fs-7">ขอบคุณที่สนับสนุนประเทศ</div>
													<p> <a href="https://discord.gg/vUp5wDQrTY" class="link-primary">Join Discord Greatful Boxing</a></div>
													</p>
												</div>
											</div>
										</div>
